...
window.CONTENT_JA = {
  ...
  sections: [
      ...
      groups: [
        ...
        },
        {
          ...
          items: [
            ...
            "字幕があるか",
            "字幕が2行以内か",
            "字幕がInstagram画面上のボタンやアイコン（UI）に重なっていないか",
            "サムネイルだけで内容が分かるか",
            "二秒ごとに違う絵になっているか",
        ...
        },
        {
          title: "Caption",
          items: [
            "1行目に読者の興味を引く一文（Hook）があるか",
            "長すぎないか",
            "必要な情報が補足されているか",
            "見た人に次の行動を促す一文（CTA：フォロー・保存・詳細を見る等）があるか",
            "ハッシュタグが適切か",
    ...
    /* ================= SECTION 6 (Website articles) ================= */
    {
      ...
      color: "green",
      title: "ホームページ記事の作り方",
      shortDesc: "JICAキルギス事務所の公式ホームページに掲載する記事の書き方と、記事用の写真の撮り方を学ぶ。",
      learn: [
        "公式ホームページの記事とInstagram投稿では、目的も読者層も違うことを説明できるようになる",
        "タイトル・リード文・段落分けの基本ルールを、具体例を見ながら実践できるようになる",
        "記事に使う写真をどう撮ればよいか（向き・構図・枚数・手ブレ対策）がわかるようになる"
      ],
      blocks: [
        { type: "heading", text: "1．ホームページ記事とInstagramの違い" },
        { type: "subheading", text: "1-1．目的とターゲットの違い" },
        { type: "para", text: "Instagramは「なんとなく見ている人に偶然見つけてもらう」メディアだが、公式ホームページは、**すでにJICAキルギス事務所について調べたい・知りたいと思っている人が、自分から情報を探しに来る**メディアである。" },
        { type: "cards3", items: [
          { label: "誰が読むか", title: "関係省庁・報道関係者・研究者・応募検討者など", icon: "users" },
          { label: "なぜ読むか", title: "事実・記録として正確な情報を探すため", icon: "message" },
          { label: "何を書くか", title: "何が・いつ・どのように行われたかを、正確かつ簡潔に", icon: "flag" }
        ]},
        { type: "decisionBox", text: "Instagramは「たまたま見た人の心をつかむ」ことが目的だが、ホームページ記事は**「探している人に、正確で分かりやすい情報を届けること」**が目的である。そのため、問いかけや煽り文句で興味を引く必要はなく、むしろ**事実を簡潔かつ正確に伝えること**を優先する。" },

        { type: "heading", text: "2．記事を書く前に" },
        { type: "list", items: [
          "**一文を短く、簡潔に書く。**一文に情報を詰め込みすぎない。",
          "書き始める前に、記事全体の構成（導入→本文→まとめ）をおおまかに考えておく。",
          "取材・現場に行く前に、分かっている情報をもとに予定稿（骨組み）を準備しておく。当日確認すべき事項を明確にしておくと、取材や執筆がスムーズになる。",
          "過去の記事を参考にするのはよいが、**表現や数字をそのままコピーしない。**日付・肩書き・数字などは必ず最新の情報に更新する。"
        ]},
        { type: "example",
          bad: "JICAキルギス事務所は、キルギス共和国政府および関係省庁と連携しながら、農業分野における人材育成や技術協力に関する複数のプロジェクトを継続的に実施してきており、その成果として現地の生産性向上に大きく寄与している。",
          badWhy: "一文に情報を詰め込みすぎており、どこが一番伝えたいポイントなのか分かりにくい。",
          good: "JICAキルギス事務所は、キルギス政府と協力して農業分野の人材育成を進めてきた。その結果、現地の生産性が向上した。",
          goodWhy: "一文を短く区切ることで、情報が整理され、読みやすくなる。" },

        { type: "heading", text: "3．インタビュー・取材に出向く場合" },
        { type: "list", items: [
          "日程調整はできるだけ早めに行う。相手の都合を最優先に考える。",
          "録音してもよいか、インタビュー開始前に確認する。",
          "約束した時間を守る。",
          "質問は事前に準備しておく。何を聞きたいのか、記事にどう使いたいのかを整理してから臨む。"
        ]},

        { type: "heading", text: "4．タイトル・見出し" },
        { type: "para", text: "タイトルは、Instagramのように「続きが気になる問いかけ」にする必要はない。**読んだだけで「誰が・何をしたか」が分かる**ことを優先する。" },
        { type: "example", bad: "キルギスで研修を実施", badWhy: "誰が、何のための研修を行ったのかが分からず、記事の内容が想像できない。",
          good: "JICA、キルギス農業省と共同で酪農技術研修を実施", goodWhy: "主体（JICA・農業省）と内容（酪農技術研修）が一目で分かる。" },
        { type: "example", bad: "新しいプロジェクトが始まりました", badWhy: "「新しい」「プロジェクト」だけでは、どこで何が始まったのか具体性がない。",
          good: "イシククル州の5つの村で新しい灌漑プロジェクトが始動", goodWhy: "場所（イシククル州）・規模（5つの村）・内容（灌漑）が具体的に分かる。" },
        { type: "example", bad: "JICAキルギス事務所は先週、ビシケク市内において関係省庁とともに教育分野の人材育成に関する意見交換会を開催し、今後の協力の方向性について議論した", badWhy: "情報を詰め込みすぎて一文が長く、タイトルとして読みにくい（目安として30〜40文字程度に収める）。",
          good: "JICAとキルギス教育科学省、人材育成の協力強化へ意見交換", goodWhy: "要点だけに絞ることで、短く一目で内容が伝わるタイトルになる。" },
        { type: "example", bad: "キルギスの教育がこんなに変わるなんて！？", badWhy: "感嘆符や煽り文句はInstagram向けの表現であり、公式記事のタイトルにはふさわしくない。",
          good: "キルギス教育科学省とJICA、教員研修プログラムを開始", goodWhy: "事実を淡々と、しかし明確に伝えるタイトルにする。" },

        { type: "heading", text: "5．リード文" },
        { type: "para", text: "リード文（記事の最初の1〜2文）では、**「誰が・いつ・どこで・何をしたか」を先に簡潔に示す。**詳しい背景や経緯は、本文で補足する。" },
        { type: "example",
          bad: "先日、とても印象的な出来事がありました。それは、キルギスの農業分野における一つの転換点になるかもしれない出来事でした。",
          badWhy: "本題（誰が・いつ・何をしたか）になかなか入らず、読者が知りたい情報にたどり着けない。",
          good: "JICAキルギス事務所は8月20日、ビシケク市内でキルギス水資源・農業・加工産業省と農業技術協力に関する会合を開催しました。",
          goodWhy: "「誰が（JICA）・いつ（8月20日）・どこで（ビシケク市内）・何をしたか（会合を開催）」が最初の一文で分かる。" },
        { type: "example",
          bad: "JICAキルギス事務所は8月20日、キルギス独立記念日を控えたビシケク市内において、2015年から継続してきた農業協力の一環として、キルギス水資源・農業・加工産業省の担当者らと今後5年間の技術協力計画について話し合う会合を、地元メディアも招いて開催しました。",
          badWhy: "情報を1文に詰め込みすぎて、かえって要点が伝わりにくい。",
          good: "JICAキルギス事務所は8月20日、ビシケク市内でキルギス水資源・農業・加工産業省と会合を開催し、今後5年間の農業技術協力について協議しました。",
          goodWhy: "リード文は要点のみに絞り、背景情報（独立記念日、2015年からの経緯など）は本文に回す。" },

        { type: "heading", text: "6．改行と段落分け" },
        { type: "list", items: [
          "**話題が変わったら、段落を変える。**一つの段落に複数の話題を詰め込まない。",
          "日本語の記事では、**1段落あたり3〜5文程度**を目安にする。長くなりすぎたら分割する。",
          "**2段落目以降**には、関係者（取材した相手）の発言・声を引用として入れると、記事の説得力が増す。"
        ]},
        { type: "subheading", text: "段落構成の例" },
        { type: "structureFlow", steps: [
          { title: "第1段落：リード", body: "「誰が・いつ・どこで・何をしたか」を簡潔にまとめる。" },
          { title: "第2段落以降：関係者の声・背景", body: "取材した相手の発言を引用として入れつつ、経緯や具体的な取り組み内容を説明する。" },
          { title: "最終段落：今後の展望", body: "今後の予定や、この取り組みが持つ意味を伝える。" }
        ]},
        { type: "quoteList", items: [
          "「この研修のおかげで、牛乳の品質管理について新しい知識を得ることができました」と、農業省の担当者は話す。",
          "「日本の技術を学べたことは、これからの仕事に大きく役立つと思います」とキルギス側の参加者は語った。"
        ]},

        { type: "heading", text: "7．執筆できたら" },
        { type: "list", items: [
          "**声に出して読み**、誤字脱字や不自然な言い回しがないか確認する。",
          "専門用語・略語はできるだけ避ける。使う場合は、必ず簡単な説明を加える。",
          "**読者層がはっきりしない場合は、中学生・高校生が読んでも理解できるかどうか**を基準に書く。"
        ]},

        { type: "heading", text: "【写真撮影編】" },
        { type: "para", text: "記事に使う写真は、Instagramのリール（縦型動画）とは撮り方が異なる。以下のポイントを押さえる。" },

        { type: "categoryHeading", num: "①", title: "横向き（ランドスケープ）で撮る", body: "Instagramのリールは縦型（9:16）が基本だが、**ホームページ記事に使う写真は横向き（16:9など）が基本。**縦向きで撮ってしまうと、記事のレイアウトに収まらず、上下や左右に余白ができてしまう。また、横向きで撮っておくと、**テレビなど他のメディアに映像・写真を提供する際にも使いやすくなる（互換性が高まる）。**" },
        { type: "ratioMockup", ratio: "16:9", label: "記事用の写真の基本比率（横向き）" },

        { type: "categoryHeading", num: "②", title: "ズームは使わず、物理的に近づく", body: "スマホのズーム機能を使うと画質が粗くなってしまう。**画質を保つため、ズームは使わず、被写体に物理的に近づいて撮影する。**" },
        { type: "goodng", ngLabel: "スマホのズーム機能で遠くから撮る", goodLabel: "ズームを使わず、被写体に近づいて撮る", note: "ズームは画質の劣化につながるため、可能な限り歩み寄って撮影する。" },

        { type: "categoryHeading", num: "③", title: "グリッド線で被写体を中央に", body: "スマホのグリッド線（格子線）を表示させ、**被写体が中央に収まるように、また体の一部が写真から切れてしまわないように**気をつける。" },
        { type: "gridMockup", wide: true, center: true, note: "グリッド線で中央に配置・欠けなし" },

        { type: "categoryHeading", num: "④", title: "集合写真は多めに（連写）", body: "集合写真は、**必ず複数枚、可能であれば連写で撮っておく。**1枚だけだと、誰か一人が目をつぶっているなど、使える写真が1枚もないという事態になりやすい。" },

        { type: "categoryHeading", num: "⑤", title: "動きのある写真も別に撮っておく", body: "記念撮影としては、被写体が直立してカメラ目線で並ぶ構図で問題ない。それに加えて、**作業している様子や、指差し・会話・笑いなど、動き（ジェスチャー）のある写真も別に撮っておく**と、記事に添付した際に実際の情景が伝わりやすくなる。" },
        { type: "list", items: [
          "記念撮影：直立してカメラ目線で並ぶ構図でよい。",
          "記事用に追加でもう一枚：作業中の様子や、動き・表情のある一瞬も撮っておく。"
        ]},

        { type: "categoryHeading", num: "⑥", title: "脇を締めて手ブレを防ぐ", body: "写真を撮るときは、**両脇をしっかり締めて構える**ことで、手ブレを大きく減らすことができる。" },

        { type: "categoryHeading", num: "⑦", title: "パノラマ撮影のコツ", body: "パノラマモードで撮影するときは、体の使い方を工夫することで、上半身（胴体）のブレを最小限に抑えられる。" },
        { type: "structureFlow", compact: true, steps: [
          { title: "① 下半身を固定", body: "腰から下は、撮影範囲全体の「真ん中」を向くように固定し、撮影中は動かさない。" },
          { title: "② 上半身をひねる", body: "撮影開始位置まで、上半身だけをひねっておく。" },
          { title: "③ ひねりを戻しながら撮影", body: "シャッターを切ったら、下半身は固定したまま、ひねっていた上半身をゆっくり戻しながら撮影する。" }
        ]},
        { type: "note", text: "下半身を固定して上半身だけを動かすことで、体の中心（軸）がぶれにくくなり、パノラマ写真の継ぎ目が滑らかになる。" }
      ],
      quiz: [
        {
          type: "mcq",
          q: "ホームページ記事とInstagram投稿の違いとして正しいのはどれ？",
          options: [
            "ホームページ記事も、Instagramと同じように問いかけや煽り文句で興味を引くことを優先するべきである",
            "ホームページ記事は、すでに情報を探している読者に、正確で分かりやすい情報を届けることを優先する",
            "ホームページ記事には読者層という考え方はない",
            "ホームページ記事はできるだけ短い文章だけで済ませ、詳しい説明は省くべきである"
          ],
          answer: 1,
          explain: "Instagramは「たまたま見た人の心をつかむ」ことが目的ですが、ホームページ記事は「探している人に、正確で分かりやすい情報を届けること」が目的です。"
        },
        {
          type: "goodng",
          q: "記事のタイトルとして、より適切なのはどちら？",
          optionA: { label: "新しいプロジェクトが始まりました", verdict: "ng" },
          optionB: { label: "イシククル州の5つの村で新しい灌漑プロジェクトが始動", verdict: "good" },
          explain: "場所・規模・内容が具体的に分かるタイトルの方が、読んだだけで記事の内容が想像できます。"
        },
        {
          type: "mcq",
          q: "リード文（記事の最初の1〜2文）で優先すべきことは？",
          options: [
            "印象的なエピソードから始め、本題は後回しにする",
            "背景や経緯をできるだけ詳しく最初に詰め込む",
            "「誰が・いつ・どこで・何をしたか」を簡潔に先に示す",
            "疑問文で読者の興味を引く"
          ],
          answer: 2,
          explain: "リード文では要点を簡潔に示し、詳しい背景や経緯は本文で補足します。"
        },
        {
          type: "truefalse",
          q: "日本語の記事では、1段落あたり3〜5文程度を目安にし、2段落目以降には関係者の声を入れるとよい。",
          answer: true,
          explain: "その通りです。話題が変わったら段落を変え、関係者の発言を引用として入れることで説得力が増します。"
        },
        {
          type: "mcq",
          q: "記事用の写真の撮り方として正しいのはどれ？",
          options: [
            "Instagramのリールと同じく、縦向き（9:16）を基本にする",
            "横向き（ランドスケープ）を基本とし、ズームは使わず被写体に近づいて撮る",
            "画質を保つため、ズーム機能を積極的に使って遠くから撮る",
            "集合写真は1枚だけ丁寧に撮ればよい"
          ],
          answer: 1,
          explain: "記事用の写真は横向きが基本です。ズームは画質が粗くなるため使わず、物理的に被写体に近づいて撮影します。集合写真は目をつぶっている人がいる可能性があるため複数枚撮っておきます。"
        }
      ]
    }
  ]
